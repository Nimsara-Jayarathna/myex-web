...
export const ControlCard = ({ title, children }: ControlCardProps) => {
  return (
    <div className="flex w-full flex-col items-center gap-2 rounded-2xl border border-[var(--border-glass)] bg-[var(--surface-glass)] p-3 shadow-soft backdrop-blur-md">
